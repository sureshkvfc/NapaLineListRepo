...
Public Class Merchand3WOMargins
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.Merchand3WOMargins.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMerchand3WOMargins
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Merchand3WOMargins = New Merchand3WOMargins()
        rpt.Site = Me.Site
        Return rpt
    End Function
