...
Public Class Merchand3Minor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.Merchand3Minor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMerchand3Minor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Merchand3Minor = New Merchand3Minor()
        rpt.Site = Me.Site
        Return rpt
    End Function
