...
Public Class ReportMerchandising6PP_delete
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportMerchandising6PP.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.ReportMerchandising6PP.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedReportMerchandising6PP_deleted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportMerchandising6PP = New ReportMerchandising6PP()
        rpt.Site = Me.Site
        Return rpt
    End Function
