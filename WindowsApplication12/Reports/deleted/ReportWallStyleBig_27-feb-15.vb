...
Public Class ReportWallStyleBig
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.ReportWallStyleBig.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportWallStyleBig
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportWallStyleBig = New ReportWallStyleBig()
        rpt.Site = Me.Site
        Return rpt
    End Function
