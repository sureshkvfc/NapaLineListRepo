...
Public Class ReportByLine
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.ReportByLine.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportByLine
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportByLine = New ReportByLine()
        rpt.Site = Me.Site
        Return rpt
    End Function
