...
Public Class Merchand3Fabric
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.Merchand3Fabric.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMerchand3Fabric
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Merchand3Fabric = New Merchand3Fabric()
        rpt.Site = Me.Site
        Return rpt
    End Function
