...
Public Class ReportWallStyle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NapaLineList.ReportWallStyle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportWallStyle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportWallStyle = New ReportWallStyle()
        rpt.Site = Me.Site
        Return rpt
    End Function
